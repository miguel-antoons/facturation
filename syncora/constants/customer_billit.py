...
class CustomerBillit(BaseModel):
    ...
    Name: str | None = Field(validation_alias="company", frozen=True)
    VATNumber: str | None = Field(validation_alias="vat_number", frozen=True)
    ...
    ContactFirstName: str | None = Field(validation_alias="surname", frozen=True)
    ContactLastName: str | None = Field(validation_alias="name", frozen=True)
    Language: str = Field(validation_alias="language", frozen=True, min_length=1)
    Email: str = Field(validation_alias="emails", frozen=True)
    Phone: str = Field(validation_alias="telephone_numbers", frozen=True)
    Mobile: str = Field(validation_alias="mobile_numbers", frozen=True)
