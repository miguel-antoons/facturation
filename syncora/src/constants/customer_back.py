...
class CustomerBack(SyncoraModel):
    ...
    postal_code: str | None = Field(default=SyncoraUndefined, alias=CUSTOMER_DB_POSTAL_CODE)
    city: str | None = Field(default=SyncoraUndefined, alias=CUSTOMER_DB_CITY)
    vat_number: str | None = Field(default=SyncoraUndefined, alias=CUSTOMER_DB_VAT_NUMBER)
    language: str | None = Field(default=SyncoraUndefined, alias=CUSTOMER_DB_LANGUAGE)
    architect_name: str | None = Field(default=SyncoraUndefined, alias=CUSTOMER_DB_ARCHITECT_NAME)
    salutation: str | None = Field(default=SyncoraUndefined, alias=CUSTOMER_DB_SALUTATION)
    ...
    def from_db(field_names: list[str], data: list) -> "CustomerBack":
        customer_db = CustomerDB(
            **{
                field: data[field_names.index(field)]
