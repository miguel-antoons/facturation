...
const Ticket = ({
  ...
  const circuitClasses = `circuit ${ticketInfo.color} ${ticketInfo.bold ? "Bold" : "Normal"} ${ticketInfo.tempBackground}Back`;
  const circuitNumberClasses = `circuitNumber ${ticketInfo.circuitNumber.color} ${ticketInfo.circuitNumber.bold ? "Bold" : "Normal"} ${ticketInfo.tempBackground}Back`;
