...
def nl_cnote(order_data: OrderBack, customer_data: CustomerBack):
...
def fr_cnote(order_data: OrderBack, customer_data: CustomerBack):
...
def cnote_gen(static_data, dyn_data: PDF) -> str:
